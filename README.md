...
[Example J.pipeline: Jenkinsfile-PostGUI-docker-build-k8s-deploy-via-helm](<img src="https://github.com/adavarski/PostGUI-k8s-demo/blob/main/pictures/PostGUI-docker-build-k8s-deploy-via-helm.png" width="900">) -> J.UI:
